...
const HeroPage = () => {
  ...
  return (
    <div className='relative w-full h-screen bg-gradient-to-br from-pink-800 via-gray-900'>
      <div></div>
      <div
        className={`absolute md:left-20 lg:left-40 xl:left-[260px] z-40 w-full h-screen flex pt-[150px] sm:pt-0 sm:items-center xl:justify-center tracking-wider text-white ${rubikBubbles.className} max-w-lg  xl:max-w-3xl text-4xl md:text-5xl xl:text-6xl font-semibold text-center px-4 capitalize`}>
